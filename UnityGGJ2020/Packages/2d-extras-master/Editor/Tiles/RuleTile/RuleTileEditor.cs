...
namespace UnityEditor
{
    ...
    public class RuleTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //tile.m_TileType = EditorGUILayout.ObjectField("Tile Type", tile.m_TileType, typeof(GameObject), false) as GameObject;
        ...
        public void DrawCustomFields()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_siblings"), new GUIContent("Sibling Tiles"), true);
