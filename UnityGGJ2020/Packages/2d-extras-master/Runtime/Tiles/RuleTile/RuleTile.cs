    ...
    public class RuleTile : TileBase
    {
        ...
        public class TilingRuleOutput
        {
            ...
            public class Neighbor
            {
                ...
                public const int MatchSiblings = 5;
                public const int NotMatchSiblings = 6;
            }
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            if (TilingRule.Neighbor.MatchSiblings != neighbor && TilingRule.Neighbor.NotMatchSiblings != neighbor)
            {
                switch (neighbor)
                {
            ...
            else
            {
                switch (neighbor)
                {
                    case TilingRule.Neighbor.MatchSiblings: return IsTileOneOfThese(other, m_Self) || IsTileOneOfThese(other, m_siblings);
                    case TilingRule.Neighbor.NotMatchSiblings: return !IsTileOneOfThese(other, m_Self) && !IsTileOneOfThese(other, m_siblings);
                }
                return true;
            }
        }
